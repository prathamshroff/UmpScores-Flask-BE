		...
		if resp != {}:
			...
			for team in TEAM_NAMES:
				team_stats = {
					'team': team,
					'season': year,
					'pitchesCalled': resp['total_call_{0}_'.format(team)],
					...
					'bcrFO': resp['BCR_{0}'.format(team) + '_FO_'],
					'bcrFF': resp['BCR_{0}'.format(team) + '_FF_'],
					'bcrFT': resp['BCR_{0}'.format(team) + '_FT_'],
					'bcrFC': resp['BCR_{0}'.format(team) + '_FC_'],
					'bcrSI': resp['BCR_{0}'.format(team) + '_SI_'],
					'bcrCH': resp['BCR_{0}'.format(team) + '_CH_'],
					'bcrSL': resp['BCR_{0}'.format(team) + '_SL_'],
					'bcrCU': resp['BCR_{0}'.format(team) + '_CU_'],
					'bcrEP': resp['BCR_{0}'.format(team) + '_EP_'],
					'bcrKC': resp['BCR_{0}'.format(team) + '_KC_'],
					'bcrFS': resp['BCR_{0}'.format(team) + '_FS_'],
					'bcrKN': resp['BCR_{0}'.format(team) + '_KN_']
				}
