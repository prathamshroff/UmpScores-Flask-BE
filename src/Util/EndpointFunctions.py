...
def create_pitcher_object(umpire_name, pitcher_name):
	...
	p_first_name = pitcher_name.split(" ")[0]
	p_last_name = pitcher_name.split(" ")[1]
	ws_ratio_attrib = "ws_ratio_" + p_first_name + "." + p_last_name
	print(ws_ratio_attrib)
	# ws_resp = pitcher_walk_strikeout.get({'name': umpire_name}, AttributesToGet=['ws_ratio_Aaron.Cook'])
	# print(ws_resp)
